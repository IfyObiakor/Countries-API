...
function Population3() {
    ...
    if (loading) {
        ...
        page_load = <div className='row'>
            ...
            <br />
            <br />
            <h2 className='mt-5'> Countries with Population Under 100 Million</h2>
                            ...
                            <div className='mt-5'>
                                ...
                                <div className="card text-black m-3" style={{ width: "100%" }}>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <hr />
                                        <p className='card-text'> <i class="automotive-van" /> {item.car.side}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
